...
const Plan = () => {
    ...
    return (
        ...
        >
            ...
            <Link href={`/apartments/floor/penthouse-top/`}><div className="absolute penthouse-top cursor-pointer  h-full w-full z-20 bg-tilia-orange opacity-60"></div></Link>
            <Link href={`/apartments/floor/seventh-floor/`}><div className="absolute seventh-floor cursor-pointer h-full w-full z-20 bg-tilia-orange opacity-60" ></div></Link>
            <Link href={`/apartments/floor/sixth-floor/`}><div className="absolute sixth-floor cursor-pointer h-full w-full z-20 bg-tilia-orange opacity-60" ></div></Link>
            <Link href={`/apartments/floor/fifth-floor/`}><div className="absolute fifth-floor cursor-pointer h-full w-full z-20 bg-tilia-orange opacity-60" ></div></Link>
            <Link href={`/apartments/floor/fourth-floor/`}><div className="absolute fourth-floor cursor-pointer h-full w-full z-20 bg-tilia-orange opacity-60" ></div></Link>
            <Link href={`/apartments/floor/third-floor/`}><div className="absolute third-floor cursor-pointer h-full w-full z-20 bg-tilia-orange opacity-60" ></div></Link>
            <Link href={`/apartments/floor/penthouse-bottom/`}><div className="absolute penthouse-bottom cursor-pointer  h-full w-full z-20 bg-tilia-orange opacity-60"></div></Link>
            <Link href={`/apartments/floor/garage-1/`}><div className="absolute garage-1 cursor-pointer h-full w-full z-20 bg-tilia-orange opacity-60" ></div></Link>
            <Link href={`/apartments/floor/garage-2/`}><div className="absolute garage-2 cursor-pointer h-full w-full z-20 bg-tilia-orange opacity-60" ></div></Link>
