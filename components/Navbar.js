        ...
        >
            <nav className={`bg-tilia-white flex flex-col z-40 w-full fixed top-0 shadow-xl`} >
                <div className="group bg-tilia-yellow-block hover:bg-black w-full flex flex-row gap-3 justify-center items-center px-2">
                    ...
                    <p className="font-semibold py-2 text-xs sm:text-sm group-hover:text-white">С Акт 15 </p>
                ...
                <div className="flex items-center justify-between mx-auto w-5/6">
                    ...
                    {/* DESKTOP NAV */}
                    <div className={`hidden lg:flex text-xl 2xl:text-2xl justify-between gap-10 2xl:gap-16 text-black font-bold`}>
                        <LinkTemplate
                            urlLink='/'
                            page="Начало"
                        />
                    ...
                    {/* MOBILE MENU POPUP */}
                    <div
                        className={`${mobileMenuVisibility} fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-80`}
                        onClick={closeModal}
                        ref={modalRef}
                    >
                        <motion.div
