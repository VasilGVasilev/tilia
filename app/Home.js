        ...
        <div>
            ...
            before:w-full before:max-w-[400px] md:before:max-w-[600px]  before:opacity-20 before:h-full before:border-2 before:border-tilia-yellow-block before:z-[-1]"
                ...
                <div className="text-left flex flex-col gap-5">
                    ...
                    >
                        Сградата се състои от две подземни нива и девет надземни етажа. Подземните нива са проектирани с гаражи за един автомобил и гаражи за два автомобила с платформа за двойно паркиране. Също така подземните нива включват мазета, техническо помещение, автомобилен асансьор, две стълбищни клетки, както и два пътнически асансьора. В имота се предвижда озеленена зона за ползване от живущите.
                    ...
                    >
                        На първия етаж са проектирани две фоайета, три жилища, автомобилен асансьор, две стълбищни клетки, два пътнически асансьора. Над първия етаж има осем жилищни етажа с двустайни и тристайни апартаменти. За вертикална комуникация са предвидени два пътнически асансьора и две стълбища. В сградата ще бъдат изградени 31 апартамента, както и 8 складови помещения-мазета извън жилищата. Предвидени са 23 гаража, от които 6 са със съоражение за двойно паркиране, две паркоместа на терен извън сградата, като така се осигуряват 31 паркоместа за автомобили. За всеки обект от сградата е осигурен по един брой автомобил.
