            ...
            <div className="">
                ...
                <div>
                    <div className="relative inline-block">
                        <div className={`absolute app-A8 h-full w-full z-10 ${red}`} title='A8 - ПРОДАДЕН'></div>
                        <Link href={`/apartments/app/A9`}><div className={`absolute app-A9 h-full w-full z-10 ${green}`} title='A9 - СВОБОДЕН'></div></Link>
                        <Link href={`/apartments/app/B10`}><div className={`absolute app-B10 h-full w-full z-10 ${green}`} title='B10 - СВОБОДЕН'></div></Link>
                        <div className={`absolute app-B11 h-full w-full z-10 ${red}`} title='B11 - ПРОДАДЕН'></div>
